...
clip_vision_model = CLIPVisionModelWithProjection.from_pretrained(
    "/home/liuhui/zhouyibo/zyb_model/models--openai--clip-vit-large-patch14-336/snapshots/ce19dc912ca5cd21c8a653c79e251e808ccabcd1"
).to(device)
...
if __name__ == "__main__":
    ...
    universal_image_path = os.path.join(
        args.save_img_dir,
        f"clip_christmas时间_numstep{args.num_steps}_lr{args.lr}.png"
    )
